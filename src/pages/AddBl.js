      ...
      <form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-8">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 text-sm rounded-md border border-gray-300 outline-none transition-all duration-300 focus:ring-2 focus:ring-[#960c0c]"
            required
          />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2 tracking-wide">
              Author Designation <span className="text-red-600">*</span>
            </label>
            <input
              type="text"
              name="designation"
